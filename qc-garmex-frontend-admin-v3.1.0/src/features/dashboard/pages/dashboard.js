...
import MainChartExample from '../../chart/pages/MainChartExample.js'
import ChartCirclePercentAnimation from '../../chart/pages/ChartCirclePercentAnimation.js'

const WidgetsDropdown = lazy(() => import('common/components/widgets/WidgetsDropdown.js'))
const WidgetsBrand = lazy(() => import('common/components/widgets/WidgetsBrand.js'))
    ...
    <>
      <CCard>
        <CCardBody>
          <CRow>
          <CCol sm="4">
              <ChartCirclePercentAnimation point="75" bottomOffset="5%"></ChartCirclePercentAnimation>
            </CCol>
            <CCol sm="4">
              <ChartCirclePercentAnimation point="90" bottomOffset="10%"></ChartCirclePercentAnimation>
            </CCol>
            <CCol sm="4">
              <ChartCirclePercentAnimation point="25" bottomOffset="15%"></ChartCirclePercentAnimation>
            </CCol>
          </CRow>
        </CCardBody>
      </CCard>
